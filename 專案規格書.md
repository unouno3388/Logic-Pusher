...
| **及閘 (AndGate)** | A | 三個輸入皆為 1 時，輸出 1。 | 決定輸入與輸出位置 |
...
* **BasePanel**：定義面板生命週期（`Open`, `Close`, `UpdatePanel`）。
* **具體實作面板**：
    * `MainMenuPanel`：遊戲主入口。
...
* **Unity Editor**：Unity6.2 以上
* **Render Pipeline**：Universal Render Pipeline (URP)
* **核心插件**：
    * **DOTween**：動畫引擎。
    * **TextMeshPro**：文字渲染系統。
    * **Input System**：現代化輸入處理。
    * **Cinemachine 3.X** : 相機跟隨
...
## 7.AI 工具協作
UI介面、UI的Shader Graphs靠AI生成、複雜邏輯代碼(非架構代碼靠AI生成)
